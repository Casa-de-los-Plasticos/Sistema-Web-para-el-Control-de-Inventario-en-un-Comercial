    ...
    <div class="card-body">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-clientes-tab" data-bs-toggle="tab" data-bs-target="#nav-clientes" type="button" role="tab" aria-controls="nav-clientes" aria-selected="true">Transportistas</button>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-3" id="nav-clientes" role="tabpanel" aria-labelledby="nav-clientes-tab" tabindex="0">
                <h5 class="card-title text-center"><i class="fas fa-users"></i> Listado de Transportistas</h5>
                <hr>
                ...
                <form id="formulario" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <label for="direccion">Direción <span class="text-danger">*</span></label>
