    ...
    <div class="card-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-3" id="nav-irs" role="tabpanel" aria-labelledby="nav-irs-tab" tabindex="0">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <label for="productos">Nombre del Producto <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-box"></i></span>
                            <input class="form-control" type="text" name="productos" id="productos" placeholder="Descripción del Producto">
                        </div>
                        <span class="text-danger fw-bold mb-2" id="errorProducto"></span>
                    </div>

                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="desde">Fecha Inicio</label>
                            <input name="desde" id="desde" class="form-control" type="date">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="hasta">Fecha Fin</label>
                            <input name="hasta" id="hasta" class="form-control" type="date">
                        </div>
                    </div>
            ...
            <div class="tab-pane fade p-3" id="nav-nuevo" role="tabpanel" aria-labelledby="nav-nuevo-tab" tabindex="0">
                <form id="formularioIrs" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        ...
                        <hr>
                        <div class="col-md-12">
                            <label for="descripcion">Buscar Por Descripción del Producto</label>
                            <div class="input-group mb-2">
                                <span class="input-group-text"><i class="fas fa-search"></i></span>
                                <input class="form-control" type="text" name="descripcion" id="descripcion" placeholder="Buscar Por Descripción del Producto">
                            </div>
                            <span class="text-danger fw-bold mb-2" id="errorDescripcion"></span>
                        </div>
                        <div class="col-md-4">
